          ...
          <div class="column is-3">
            <aside class="is-medium menu">
              ...
              <div class="meetup-side-box-map">
                <img src="../assets/img/bg-map.png" class="venueMap-mapImg span--100" alt="Location image of meetup venue">
              </div>
              <!-- Threads Start -->
              <p class="menu-label">
                Threads
...
<style scoped lang="scss">
  ...
  .meetup-detail-page {
    ...
    .hero-body {
      ...
      color: white;
      background-image: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('https://images.unsplash.com/photo-1512805147242-c3e79caf64bf?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80');
